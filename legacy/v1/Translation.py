...
def main() -> None:
    ...
    plot1_path = os.path.join(save_dir, f"olmo2_{input_lang}_{target_lang}_probas_ent{suffix}.png")
    ...
    plot2_path = os.path.join(save_dir, f"olmo2_{input_lang}_{target_lang}_energy{suffix}.png")
